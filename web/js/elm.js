			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'border-top', '1px dashed #ccc')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Export as PDF:')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Booklet PDF')
									]))
							]))
					])),
				A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Delete this recipe?')
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
